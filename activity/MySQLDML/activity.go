...
var log = logger.GetLogger("activity-Database_Insert")
...
func (a *MyActivity) Eval(context activity.Context) (done bool, err error) {
	...
	if strings.ToLower(queryCheck[0]) == "select" {
		fmt.Println("Operation Type: Select")
	}
	if strings.ToLower(queryCheck[0]) == "insert" {
		fmt.Println("Operation Type: Insert")
	}
	if strings.ToLower(queryCheck[0]) == "update" {
		fmt.Println("Operation Type: Update")
	}
	if strings.ToLower(queryCheck[0]) == "delete" {
		fmt.Println("Operation Type: Delete")
	}
